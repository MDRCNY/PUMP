...
test_that("WY-SS results are stable for design: d2.1_m2fc (constant)", {
  ...
  set.seed(23453434)
  mdes1 <- pump_mdes( design = "d2.1_m2fc",
                     MTP = "WY-SS",
                     target.power = 0.4,
  ...
  set.seed(23453434)
  mdes2 <- pump_mdes( design = "d2.1_m2fc",
                      MTP = "WY-SS",
                      target.power = 0.4,
                      power.definition = 'min1',
                      M = 3,
  ...
  expect_equal( mdes1$Adjusted.MDES, mdes2$Adjusted.MDES, tol = default.tol)
  ...
  ss2 <- pump_mdes( design = "d2.1_m2fc",
                      MTP = "WY-SS",
                      target.power = 0.4,
                      power.definition = 'min1',
                      typesample = 'J',
  ...
  expect_equal( mdes1[2,2], mdes2[2,2], tol = default.tol)
})
