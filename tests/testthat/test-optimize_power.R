...
test_that( "optimize bounded logistic elements work", {
    ...
    probs = PUMP:::bounded_logistic_curve( x, par_true )
    ...
    par_est = PUMP:::fit_bounded_logistic( x, y, size )
    par_est
    ...
    xover = PUMP:::find_crossover( 0.4, par_true )

    expect_true( PUMP:::bounded_logistic_curve( xover, par_true ) == 0.4 )

    xover = PUMP:::find_crossover( 0.54, par_true )

    expect_true( PUMP:::bounded_logistic_curve( xover, par_true ) == 0.54 )
