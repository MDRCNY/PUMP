...
The default tolerance is $0.01$, meaning we can get any $K$ that has an estimated power within 1\% of our target power.
...
We can also examine the power for a grid of points up to our selected $J$ (this is a second estimation step to verify our results):
```{r, fig.width=7}
power_curve(J1)
```
...
For example, a sample size of 29 results in a power of `0.769`, even though we initially input a sample size of 30 to get our target power of `0.80.`
