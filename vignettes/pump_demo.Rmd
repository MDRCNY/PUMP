...
To speed up computation, we could also set an additional option, `parallel.WY.cores`, to the number of desired cores to parallelize the computation.
...
Next, we will evaluate a variety of different scenarios.
...
The impact on individual adjustment is flat, as anticipated.
Additionally, across a very broad range of rho, we maintain good $1-$minimal power.
