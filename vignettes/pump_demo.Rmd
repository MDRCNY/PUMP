...
p2 <- update( p_check,
              MTP = c( "BF", "HO", "WY-SD" ),
              tnum = 5000, parallel.WY.cores = 2 )
plot( p2 )
```

To speed up computation, we set an additional option, `parallel.WY.cores`, to the number of desired cores to parallelize the computation.
