...
The levels of this design are the random assignment (RA) blocks at level 3, schools as clusters at level 2, and students nested within the schools at level 1.  RA blocks are nested in districts, but if we use fixed effects for the RA blocks, then we can ignore this 4th level of nesting.
...
# KP should we add a sentence or two about the adjustment strategy here and the use of domain composites as recommened by Schochet (2008) and mentionin footnote 2 of my 2017 paper?
